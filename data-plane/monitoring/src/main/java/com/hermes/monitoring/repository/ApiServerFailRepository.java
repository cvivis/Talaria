...
public interface ApiServerFailRepository extends JpaRepository<ServerFail, Integer> {
    ...
    List<ApiRankingVo> findStatusCodeAndCountAndAvgCount(String groupName);

    interface ApiRankingVo{
